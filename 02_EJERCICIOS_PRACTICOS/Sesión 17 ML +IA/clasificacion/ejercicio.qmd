---
title: "Solución de referencia: CLASIFICACIÓN binaria"
...
*Problema: predecir si una póliza de seguro de vida será aprobada. Modelo: KNN con el número de vecinos (k) tuneado por validación cruzada.*
...
## Interpretación: — - El AUC resume la capacidad de discriminación: 0.5 es azar, 1.0 perfecto. — - Con clases balanceadas, accuracy es informativo, pero sensibilidad y —   especificidad nos dicen en qué clase fallamos más. — - El k elegido por validación cruzada equilibra sesgo y varianza: k chico —   sobreajusta, k grande subajusta.
