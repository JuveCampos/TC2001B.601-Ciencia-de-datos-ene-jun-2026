# ============================================================================
# Aplicación Shiny - Examen de Opción Múltiple (25 preguntas fijas)
# Curso: TC2001B - Ciencia de datos para política pública
# Tec de Monterrey
# ============================================================================
#
# Descripción:
# Presenta las 25 preguntas del examen en el orden definido por el archivo
# RDS de preguntas. El estudiante responde, recibe su calificación y, si la
# acepta, visualiza las preguntas incorrectas con la explicación.
#
...
# CONFIGURACIÓN
# ----------------------------------------------------------------------------
ruta_preguntas <- "examen_25_preguntas.rds"
...
server <- function(input, output, session) {
  ...
  renderizar_inicio <- function() {
    div(class = "panel-inicio",
        h2("Bienvenido al examen"),
        p("El examen consta de 25 preguntas de opción múltiple sobre los temas del curso. Responde cada pregunta y, al finalizar, presiona \"Calificar examen\" para obtener tu resultado."),
  ...
  observeEvent(input$btn_comenzar, {
    if (is.null(estado$examen)) {
      estado$examen <- cargar_banco(ruta_preguntas)
    }
    estado$etapa <- "examen"
  })
